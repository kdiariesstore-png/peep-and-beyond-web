  ...
  const moments =
    locale === "ar"
      ? [
          ...
          { title: "العب", body: "خريطة مغناطيسية وبزل بيب لوقت لعب مليء بالخيال.", image: "/images/scene-play.png" },
      ...
      : [
          ...
          { title: "Play", body: "A Peep puzzle and magnetic map for imaginative play.", image: "/images/scene-play.png" },
